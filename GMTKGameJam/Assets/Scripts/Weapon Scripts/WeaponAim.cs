...
{ 
    ...
    void Update()
    {
        ...
        Vector2 direction = mousePosition - transform.position.XY();
        ...
        for (int i = 0; i < weaponList.Count; i++)
        {
            ...
            weapon.transform.position = Vector2.Lerp(weapon.transform.position, (new Vector2(Mathf.Cos(weaponPosAngle), Mathf.Sin(weaponPosAngle)) * orbitRadius) + transform.position.XY(), lerpRate);

            Vector2 weaponDir = mousePosition - weapon.transform.position.XY();
